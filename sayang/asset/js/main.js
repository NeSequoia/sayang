...
$(document).on('click', '#tombolPopup', function (e) {
    ...
    Swal.fire({
        ...
        Swal.fire({
            ...
            Swal.fire({
                icon: 'error',
                title: 'Awas saja jika berbohong',
                text: 'Jangan bohong',
                showClass: {
                    popup: 'animate__animated animate__jackInTheBox'
                },
                ...
                Swal.fire({
                    title: 'Masukkin nama kamu terlebih dahulu dong',
                    showClass: {
                        popup: 'animate__animated animate__jackInTheBox'
                    },
                    hideClass: {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    ...
                                    Swal.queue([{
                                        title: 'Seberapa sayang' + ' ' + nama + ' ' + 'padaku?',
                                        confirmButtonText: 'Submit',
                                        showCancelButton: true,
                                        text: 'Aku pengen tahu, seberapa sayang kamu sama aku',
                                        showClass: {
                                            popup: 'animate__animated animate__jackInTheBox'
                                        },
                                        hideClass: {
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'Terima kasih sudah sayang aku, cieee.' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                        ...
                                        Swal.fire({
                                            title: 'Sekarang' + ' ' + nama + ' ' + 'kangen aku?',
                                            icon: 'question',
                                            type: 'question',
                                            showClass: {
                                                popup: 'animate__animated animate__jackInTheBox'
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    ...
                                                    Swal.fire({
                                                        title: 'Terakhir nih',
                                                        icon: 'info',
                                                        text: 'Langsung klik oke saja ya!',
                                                        showClass: {
                                                            popup: 'animate__animated animate__jackInTheBox'
                                                        },
                                                        hideClass: {
                                ...
                                Swal.fire({
                                    title: 'Beneran? Aku tanya sekali lagi nih. Sayang aku?',
                                    icon: 'question',
                                    text: 'Coba jawab yang benar',
                                    showCancelButton: true,
                                    confirmButtonText: 'Beneran, tidak',
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            ...
                                            Swal.queue([{
                                                ...
                                                confirmButtonText: 'Submit',
                                                showCancelButton: true,
                                                text: 'Aku pengen tahu, seberapa sayang kamu ke aku',
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                                hideClass: {
                                                ...
                                                preConfirm: function (value) {
                                                    Swal.insertQueueStep({
                                                        title: 'Terima kasih sudah sayang aku ' + ' ' + value + '%',
                                                        icon: "info"
                                                    })
                                                },
                                                allowOutsideClick: () => !Swal.isLoading()
